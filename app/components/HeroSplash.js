...
export default function HeroSplash({ appName, imageSrc, onEnter }) {
  return (
    <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      {/* Container holding both the large image and text */}
      <motion.div 
      ...
      >
        ...
        {/* Text Written Directly on Top of the Image */}
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 pointer-events-none">
          ...
          <motion.button 
            ...
            onClick={onEnter}
            className="pointer-events-auto mt-6 text-xs uppercase tracking-widest text-teal-950 font-bold bg-teal-300 hover:bg-teal-200 px-8 py-3.5 rounded-full shadow-lg backdrop-blur-md border border-white/20 transition-all duration-200 hover:scale-105 cursor-pointer"
          >
