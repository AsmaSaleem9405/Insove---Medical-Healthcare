...
export default function HeroSection() {
  ...
  return (
    <main ref={containerRef} className="w-full bg-[#E8F0F1] overflow-hidden perspective-[1400px]">
      <motion.section 
        id="home"
        style={{ scale, rotateX, transformStyle: 'preserve-3d' }}
        className="relative flex items-center overflow-hidden bg-[#E8F0F1] py-12 md:py-0 will-change-transform"
        style={{
          width: "100%",
          maxWidth: "1920px",
          minHeight: "510px",
      ...
      >
        ...
        <div className="max-w-[1300px] mx-auto px-6 md:ml-26 w-full grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-6 items-center">
          ...
          {/* Left Side: Staggered Content Animation with viewport once: false */}
          <motion.div 
          ...
          >
            ...
            >
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                className="group flex items-center space-x-2 px-8 py-4 md:py-5 rounded-full bg-[#1CBCCF] text-white font-semibold text-xs sm:text-sm shadow-md shadow-cyan-400/25 hover:shadow-lg hover:shadow-cyan-400/35 transition-all duration-200"
              >
          ...
          {/* Right Side: Circular Background Shape & Doctor Image with viewport once: false */}
          <motion.div 
